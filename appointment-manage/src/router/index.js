...
export const constantRouterMap = [
...

  {
    ...
    children: [{
      path: 'dashboard',
      component: () => import('@/views/hospitalSet/list') //默认首页为列表页面
    }]
  },

  {
    path: '/hospitalSet', //路径
    component: Layout, //布局
    redirect: '/hospitalSet/list', //跳转地址
    name: '医院设置管理', 
    meta: { title: '医院设置管理', icon: 'example' },  //标题与图标
    children: [  //子目录
      {
        path: 'list',
        name: '医院设置列表',
        component: () => import('@/views/hospitalSet/list'),  //跳转页面的路径
