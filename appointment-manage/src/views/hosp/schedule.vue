...
export default{
    ...
    created(){
        ...
        this.workDate = this.getCurDate()//获取当前选择日期
        this.fetchData()
    },
    methods:{
        //查询封装好的科室列表
        ...
        getScheduleRule() {
            hospApi.getScheduleRule(this.page, this.limit, this.hoscode, this.depcode).then(response => {
                ...
                this.scheduleList = response.data.scheduleList//排班详细信息
        ...
        //查询排班详情
        getDetailSchedule() {
            hospApi.getScheduleDetail(this.hoscode,this.depcode,this.workDate).then(response => {
