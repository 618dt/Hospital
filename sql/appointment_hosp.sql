/*
 ...
 Source Schema         : appointment_hosp

 Target Server Type    : MySQL
 Target Server Version : 80021
 File Encoding         : 65001

 Date: 22/02/2022 20:15:08
*/
...
CREATE TABLE `hospital_set`  (
  ...
  `status` tinyint(0) NOT NULL DEFAULT 0 COMMENT '状态(1:可以连接;0:接口已经锁定，无法连接)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '医院设置表' ROW_FORMAT = Dynamic;
